    ...
    <div className="p-4">
      <div className="mb-2 flex items-center gap-1">
        ...
        <span className="text-xs text-gray-500">
          ({Array.isArray(product.userReviews) ? product.userReviews.length : product.reviews || "925"} reviews)
        </span>
      </div>
      ...
      <p className="mb-3 text-xs font-medium" style={{ color: "var(--brand-purple)" }}>
