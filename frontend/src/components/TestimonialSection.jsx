    ...
    <section className="relative bg-white py-16 sm:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex w-full">
          <div 
            className={`flex w-full gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-8 px-2 ${justifyClass}`}
            style={{ scrollBehavior: 'smooth' }}
          >
            {testimonials.map((testimonial, index) => (
              <div
                key={testimonial._id || index}
                className="flex-shrink-0 w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(25%-1.125rem)] snap-center bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col justify-between group transform hover:-translate-y-2"
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <p className="relative z-10 text-gray-700 font-medium mb-8 leading-relaxed tracking-wide min-h-[5rem]">
                      "{testimonial.review}"
                    </p>
                  </div>
                </div>
